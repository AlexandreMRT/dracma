...
class Arel::Attributes::Attribute < Anonymous_Struct_19
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_20
end
...
class ActiveRecord::Type::Time::Value < Anonymous_Delegator_21
end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_22
  def accessor; end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_23
  def pretty_print(pp); end
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_24
  def deserialize(value); end
  def encode_with(coder); end
  def init_with(coder); end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_25
  def ==(other); end
  def cast(value); end
...
class ActiveRecord::Normalization::NormalizedValueType < Anonymous_Delegator_26
  def ==(other); end
  def cast(value); end
  def cast_type; end
  def eql?(other); end
